...
final class PacketInspectorViewController: NSViewController {
    ...
    private func makeSummaryView(state: PacketInspectorRenderState) -> NSView {
        ...
        let title = PacketmanUI.label(summarySentence(for: packet), font: .systemFont(ofSize: NSFont.systemFontSize + 1, weight: .semibold))
    ...
    private func loadingView(message: String) -> NSView {
        ...
        let label = PacketmanUI.label(message, font: .systemFont(ofSize: NSFont.systemFontSize), color: .secondaryLabelColor)
    ...
    private func makeBadge(_ text: String) -> NSView {
        let label = PacketmanUI.label(text, font: .systemFont(ofSize: NSFont.smallSystemFontSize, weight: .medium), color: .secondaryLabelColor)
