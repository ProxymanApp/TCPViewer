...
final class StatusStripViewController: NSViewController {
    ...
    private let statusLabel = PacketmanUI.label("", font: .systemFont(ofSize: NSFont.smallSystemFontSize))
    ...
    func render(snapshot: NetworkInspectorSnapshot) {
        ...
        statusImageView.image = PacketmanUI.image(viewModel.statusImageName)
