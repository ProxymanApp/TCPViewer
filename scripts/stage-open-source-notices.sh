...
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/EventSource-LICENSE.md" "EventSource-LICENSE.md"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftSystem-LICENSE.txt" "SwiftSystem-LICENSE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftAtomics-LICENSE.txt" "SwiftAtomics-LICENSE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftCollections-LICENSE.txt" "SwiftCollections-LICENSE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftNIO-LICENSE.txt" "SwiftNIO-LICENSE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftNIO-NOTICE.txt" "SwiftNIO-NOTICE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftLog-LICENSE.txt" "SwiftLog-LICENSE.txt"
copy_notice "$PROJECT_DIR/ThirdPartyLicenses/SwiftLog-NOTICE.txt" "SwiftLog-NOTICE.txt"
write_runtime_manifest
