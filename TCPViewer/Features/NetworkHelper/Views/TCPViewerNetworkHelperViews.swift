...
struct TCPViewerSettingsView: View {
    ...
    var body: some View {
        TabView {
            TCPViewerNetworkHelperSettingsView(manager: networkHelperToolManager)
                .tabItem {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                Label("Allows TCP Viewer to capture packets without running the app as root.", systemImage: "checkmark.shield")
                Label("Adjusts local /dev/bpf* device permissions for TCP Viewer capture access.", systemImage: "slider.horizontal.3")
