...
TCP Viewer is distributed under the GNU General Public License, version 2.0 or
...
If the complete corresponding source code was not provided with your binary
distribution, Proxyman LLC will provide a machine-readable copy for no more than
the cost of physically performing source distribution. This written offer is
valid for at least three years from the date you received the binary
distribution.

Contact: tcpviewer@proxyman.com
